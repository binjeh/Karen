...
func PrintLogo() {
    ...
    // A time where the code was "rusty" and in very early stages.
    // We'll never forget you Karen V1 and V1.5 ;-;
    //
    logo := []string{
        "",
        ...
        `888   d8P`,
        `888  d8P`,
        `888d88K      8888b.  888d888 .d88b.  88888b.`,
        `8888888b        "88b 888P"  d8P  Y8b 888 "88b`,
        `888  Y88b   .d888888 888    88888888 888  888`,
        `888   Y88b  888  888 888    Y8b.     888  888`,
        `888    Y88b "Y888888 888     "Y8888  888  888`,
        ``,
    }
